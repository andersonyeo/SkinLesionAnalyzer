...
(async function () {
	...
	model = await tf.loadModel('https://andersonyeo.github.io/SkinLesionAnalyzer/final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://andersonyeo.github.io/SkinLesionAnalyzer/assets/samplepic.jpg");
